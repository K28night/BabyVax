...
$fields=array('id','parent_id','baby_id','vaccine_id','side_effects','report_date');
                $users = $dao->selectAsTable($fields, 'reported_side_effects as s',"parent_id='$pid' AND status=1", null, $actions, $config);
