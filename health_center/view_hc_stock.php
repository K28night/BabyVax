            ...
            <div class="row">
                <div class="col-md-10 center">
                    <table class="table">
                        ...
                        $vaccines = $dao->getData($fields, 'vaccine_stocks', "c_id='$hid'");
                        ...
                        if (!empty($vaccines)) {
                            foreach ($vaccines as $row) {
                                ...
                                $availability = !empty($avail[0]['is_available']) ? 'Open' : 'Closed';
                                ...
                                echo "<td><a href='hc_request_stock.php?id=" . $row['s_id'] . "&hid=".$hid."' class='btn btn-primary update-btn'>Send Request</a></td>";
                                echo "</tr>";
                            }
                        } else {
