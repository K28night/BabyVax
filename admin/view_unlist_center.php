...
<head>
    ...
    <title>Unlisted Health Centers</title>
            ...
            <table class="table">
                ...
                $config = array(
                    ...
                    'images' => array(
                        'field' => 'img',
                        'path' => '../uploads/',
                        'attributes' => array('style' => 'width:150px; height:100px;') // Ensure attributes match
                    )
                );

                $fields = array('hid','lid', 'hname','location','phno','img');

                $users = $dao->selectAsTable($fields, 'hcenters as s', "approve_ad='0'", null, $actions, $config);
